    ...
    <div class="login-wrap">
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="login-form" size="medium">
        ...
        <el-form-item prop="password2" class="form-item" v-if="this.model === 'register'">
          ...
          <el-input type="password" v-model="ruleForm.password2" autocomplete="off" maxlength="20" minlength="6"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="checkCode" class="form-item">
          ...
          <el-row :gutter="12">
            <el-col :span="15">
              <el-input v-model.number="ruleForm.checkCode" maxlength="6" minlength="6"></el-input>
            </el-col>
            <el-col :span="9">
              <el-button type="success" class="block" size="medium">获取验证码</el-button>
            </el-col>
          </el-row>
        </el-form-item>
